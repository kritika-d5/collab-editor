...
export function useCollabEditor({ sessionId, userId, username, enabled = true }) {
    ...
    useEffect(() => {
        ...
        const provider = new WebsocketProvider(YJS_URL, sessionId, ydoc, { connect: true, resyncInterval: 3000, params: { token: token ?? '' } });
